...
docker build -t fund-distribution-scripts:latest ./helm/fund-distribution && \
...
kubeseal --cert sealed-secrets.crt -o yaml < real-secrets/flush-timeboost-secret.yaml > ./raw/secrets/flush-timeboost-secret.yaml && \
